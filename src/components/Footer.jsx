...
const Footer = () => {
  return (
    ...
    <div className='absolute below-md:left-[1rem] object-cover left-[13rem]'>
    <div className="bg-black absolute overflow-hidden below-md:w-[25rem] w-[60rem] top-[2rem] below-md:top-[6rem] text-white py-[3.5rem] px-4 rounded-3xl h-[18rem] text-center">
