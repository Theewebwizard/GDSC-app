    ...
    <div className='absolute w-full h-screen overflow-hidden' ref={ref}>
      {isInView && (
        <>
          ...
          <motion.div
            className='w-[5rem] below-md:right-[18rem] below-md:top-[41rem] absolute right-[28rem] top-[18rem]'
            initial="initial"
            animate="animate"
            {...animations('down', 1.6)}
          >
          ...
          <motion.div
            className='w-[3rem] below-md:right-[19rem] below-md:top-[51rem] absolute right-[28rem] top-[29.5rem]'
            initial="initial"
            animate="animate"
            {...animations('down', 1.8)}
          >
